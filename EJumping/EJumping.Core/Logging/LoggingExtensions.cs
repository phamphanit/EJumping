...
namespace EJumping.Core.Logging
{
    public static class LoggingExtensions
    {
        private static void UseGlobalLogger(this IWebHostEnvironment env, LoggingOptions options)
        {
        ...
        private static LoggingOptions SetDefault(LoggingOptions options)
        {
            ...
            options.File ??= new EJumping.Core.Logging.FileOptions
            {
        ...
        public static IWebHostBuilder UseGlobalLogger(this IWebHostBuilder builder, Func<IConfiguration, LoggingOptions> logOptions)
        {
            builder.ConfigureLogging((context, logging) =>
            {
                ...
                context.HostingEnvironment.UseGlobalLogger(options);
            });
