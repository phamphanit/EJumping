        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    link_url = table.Column<string>(type: "character varying", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    first_number = table.Column<int>(type: "integer", nullable: false),
                    second_number = table.Column<int>(type: "integer", nullable: false),
                    round_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dice_round", x => x.id);
                });
